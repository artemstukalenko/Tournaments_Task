...
public interface TextConstants {
    String GREETING = "Hello! Please, choose an entity to work with! Type R for roles or U for users";
    String WRONG_INPUT = "Wrong input!";
    String WHAT_TO_DO_WITH = "What do you want to do with this entity? Type R to read; A to add; D to delete";
    String ENTITY_ADDED = "Entity added successfully!";
    String UNEXPECTED_ERROR_OCCURRED = "Unexpected error has occurred!";
    String ENTER_NAME_FOR_NEW_ENTITY = "Enter name for new entity:";
